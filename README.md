...
1. Install Node.js from [here](https://nodejs.org/download/release/latest-v6.x/).  
...
3. Run the command `cf marketplace` and check for the service name for hana in your account (it could be hanatrial or hana, it depends if you are using a trail or enterprise account)
4. In line no. 141 of mta.yaml update the service name to hanatrial or hana based on your account
5. In line no. 178 of mta.yaml update the url property of the controller to the Cloud Foundry API endpoint of the region you are using (see above).
6. Check the Cloud Foundry org and space names to which you are planning to deploy.
