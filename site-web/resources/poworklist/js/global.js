    ...
    var oBundle = jQuery.sap.resources({
        url: "/resources/poworklist/i18n/messagebundle.hdbtextbundle",
        locale: sLocale
    });
    ...
    jQuery.sap.registerModulePath('app', '/shine/democontent/epm/poworklist/js');
    jQuery.sap.require("shine.democontent.epm.poworklist.js.tileDialog");
